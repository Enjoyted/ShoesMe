...
class FemmesController extends AppController {
    ...
    public function beforeFilter() 
    {
 	...
 	public function sub_category()
 	{
 		  ...
 		  $this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.souscategorie_id' => $action , 'Chaussure.categorie' => 'Femme'),
				'recursive' => -1
				)
			)
		);
	...
	public function index(){
		...
		$this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.categorie' => 'Femme'),
				 'recursive' => -1,
		...
		{
			$this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.categorie' => 'Femme' , 'Chaussure.souscategorie_id' => $souscat),
				 'recursive' => -1
				) 
			)
		);
		...
		{
			$this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.categorie' => 'Femme' , 'Chaussure.marque_id' => $marque),
				 'recursive' => -1
				) 
			)
		);
		...
		{
		$this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.categorie' => 'Femme' , 'Chaussure.couleur' => $couleur),
				 'recursive' => -1
				)
			)
		);
		...
		{
		$this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.categorie' => 'Femme' , 'Chaussure.souscategorie_id' => $souscat, 'Chaussure.marque_id' => $marque ),
				 'recursive' => -1
				)
			)
		);
		...
		{
		$this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.categorie' => 'Femme' , 'Chaussure.souscategorie_id' => $souscat, 'Chaussure.couleur' => $couleur),
				 'recursive' => -1
				)
			)
		);
		...
		{
		$this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.categorie' => 'Femme' , 'Chaussure.couleur' => $couleur, 'Chaussure.marque_id' => $marque ),
				 'recursive' => -1
				)
			)
		);
		...
		{
		$this->set('chaussures', $this->Chaussure->find('all', array(
				'conditions' => array('Chaussure.categorie' => 'Femme' , 'Chaussure.couleur' => $couleur, 'Chaussure.marque_id' => $marque, 'Chaussure.souscategorie_id' => $souscat),
				 'recursive' => -1
				)
			)
		);
