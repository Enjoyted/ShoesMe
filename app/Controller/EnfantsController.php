...
class EnfantsController extends AppController {
    ...
    public function sub_category()
    {
          ...
          $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.souscategorie_id' => $action , 'Chaussure.categorie' => 'enfant'),
                'recursive' => -1
                )
            )
        );
    ...
    public function index(){
        ...
        $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.categorie' => 'enfant'),
                 'recursive' => -1,
        ...
        {
            $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.categorie' => 'enfant' , 'Chaussure.souscategorie_id' => $souscat),
                 'recursive' => -1
                ) 
            )
        );
        ...
        {
            $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.categorie' => 'enfant' , 'Chaussure.marque_id' => $marque),
                 'recursive' => -1
                ) 
            )
        );
        ...
        {
        $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.categorie' => 'enfant' , 'Chaussure.couleur' => $couleur),
                 'recursive' => -1
                )
            )
        );
        ...
        {
        $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.categorie' => 'enfant' , 'Chaussure.souscategorie_id' => $souscat, 'Chaussure.marque_id' => $marque ),
                 'recursive' => -1
                )
            )
        );
        ...
        {
        $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.categorie' => 'enfant' , 'Chaussure.souscategorie_id' => $souscat, 'Chaussure.couleur' => $couleur),
                 'recursive' => -1
                )
            )
        );
        ...
        {
        $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.categorie' => 'enfant' , 'Chaussure.couleur' => $couleur, 'Chaussure.marque_id' => $marque ),
                 'recursive' => -1
                )
            )
        );
        ...
        {
        $this->set('chaussures', $this->Chaussure->find('all', array(
                'conditions' => array('Chaussure.categorie' => 'enfant' , 'Chaussure.couleur' => $couleur, 'Chaussure.marque_id' => $marque, 'Chaussure.souscategorie_id' => $souscat),
                 'recursive' => -1
                )
            )
        );
